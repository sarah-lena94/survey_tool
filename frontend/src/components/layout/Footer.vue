<template>
  <footer class="border-t bg-white">
    <div class="container flex flex-col gap-4 py-8 md:flex-row md:items-center md:justify-between md:py-6 px-4 md:px-6">
      <div class="flex items-center gap-2">
        <div class="bg-gradient-to-br from-teal-500 to-purple-500 p-1.5 rounded-lg">
          <svg
        ...
        <span class="font-bold text-lg bg-gradient-to-r from-teal-600 to-purple-600 bg-clip-text text-transparent">
          Teammeter
        </span>
      </div>
